...
const Alert = () => {
  ...
  return (
    ...
    <Navbar/>
    <div className='body' >
     <div className="loader" style={{backgroundColor:"transparent"}}>
        <div className="loader-circle"style={{backgroundColor:"transparent"}} ></div>
        <div className="exclamation-mark"style={{backgroundColor:"transparent"}} >!</div>
    </div>
